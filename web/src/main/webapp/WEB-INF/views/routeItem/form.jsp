...
<h4 class="header">
    <c:if test="${!readonly}">
        <mytaglib:i18n key="page.content.edit" />
    </c:if>
    <mytaglib:i18n key="page.content.routeItem" />
</h4>
<div class="row">
    <form:form class="col s12" method="POST" action="${baseUrl}" modelAttribute="formModel">
        ...
        <div class="row">
            <div class="input-field col s12">
                <label for="ordinalNum"><mytaglib:i18n key="page.content.ordinal" />: ${formModel.ordinalNum}</label>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col s3">
                <c:if test="${!readonly}">
                    <button class="btn waves-effect waves-light right green darken-3" type="submit">
                        <mytaglib:i18n key="page.content.save" />
                    </button>
                </c:if>
            </div>
            <div class="col s3">
                <a class="btn waves-effect waves-light right light-blue" href="${url}"><mytaglib:i18n key="page.content.toList" /><i
