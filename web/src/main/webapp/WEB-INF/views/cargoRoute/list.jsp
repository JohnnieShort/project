...
<table class="bordered highlight">
	<tbody>
		...
		<c:forEach var="cargoRoute" items="${gridItems}" varStatus="loopCounter">
			...
			<td><c:out value="${cargoRoute.trainId}" /></td>
				...
				<td class="right">
					<a class="btn-floating"	href="${baseUrl}/${cargoRoute.id}"><i class="material-icons">info</i></a>
					<a class="btn-floating yellow darken-1" href="${baseUrl}/${cargoRoute.id}/edit"><i class="material-icons">edit</i></a> 
					<a class="btn-floating red "href="${baseUrl}/${cargoRoute.id}/delete"><i class="material-icons">delete</i></a>
				</td>
			</tr>
		</c:forEach>
	</tbody>
