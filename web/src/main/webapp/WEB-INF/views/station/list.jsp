...
<table class="bordered highlight">
	<tbody>
		...
		<c:forEach var="station" items="${gridItems}" varStatus="loopCounter">
			<tr>
				...
				<td class="right">
					<a class="btn-floating"	href="${baseUrl}/${station.id}"><i class="material-icons">info</i></a>
					<a class="btn-floating yellow darken-1" href="${baseUrl}/${station.id}/edit"><i class="material-icons">edit</i></a> 
					<a class="btn-floating red "href="${baseUrl}/${station.id}/delete"><i class="material-icons">delete</i></a>
				</td>
			</tr>
		</c:forEach>
	</tbody>
