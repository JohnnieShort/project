    ...
    <form:form class="col s12" method="POST" action="${baseUrl}" modelAttribute="formModel">
        ...
        <c:if test="${empty passengerId}">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input id="street" name="street" type="text" value="${street}" class="validate"> <label for="street">street:</label>
                </div>
                <div class="input-field col s3">
                    <input id="building" name="building" type="number" value="${building}" class="validate"> <label for="building">building:</label>
                </div>
                <div class="input-field col s3">
                    <input id="apartments" name="apartments" type="number" value="${apartments}" class="validate"> <label for="apartments">apartments:</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s6">
                    <input id="phone" name="phone" type="text" value="${phone}" class="validate"> <label for="phone">phone number:</label>
                </div>
            </div>
        </c:if>
        <div class="row">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input id="quantity" name="quantity" type="text" value="${quantity}" class="validate"> <label for="quantity">quantity</label>
            </div>
        </div>
        <div class="row">
