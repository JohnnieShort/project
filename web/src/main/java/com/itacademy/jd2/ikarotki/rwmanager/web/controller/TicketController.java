...
public class TicketController extends AbstractController<TicketDTO> {
	...
	private TicketController(ITicketService ticketService, TicketToDTOConverter toDtoConverter,
			TicketFromDTOConverter fromDtoConverter, IStationService stationService, IPassengerService passengerService,
	...
	public ModelAndView index(final HttpServletRequest req,
		...
		loadPassengers(models);
		loadStations(models);
		return new ModelAndView("ticket.list", models);
	}

	private void loadStations(Map<String, Object> models) {
		List<IStation> stations = stationService.find(new StationFilter());
		Map<Integer, String> stationsChoices = stations.stream()
				.collect(Collectors.toMap(IStation::getId, station -> station.getName()));
		models.put("stationsChoices", stationsChoices);
	}

	private void loadPassengers(Map<String, Object> models) {
		...
		Map<Integer, String> passengersData = passengers.stream()
		...
		models.put("passengerChoices", passengersData);
