...
public class PersonalPageController {
	...
	public ModelAndView showPage() {
		...
		if (passengerId != null) {
			...
			List<ITicket> tickets = ticketService.findByPassenger(ticketFilter, passengerId);
			Map<Integer, String> ticketsDTO = tickets.stream().collect(Collectors.toMap(ITicket::getId,
					ticket -> ticket.getStationFrom().getName() + "->" + ticket.getStationTo().getName()));
